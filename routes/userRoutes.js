...
router.patch("/users/:id", upload.single("profileImage"),userEditValidations,errorsIsEmpty, expressjwt({algorithms: ["HS256"], secret: process.env.JWT_KEY}), userController.editUser);
