...
import errorIsEmpty from "../middlewares/errorIsEmpty.js";

const router = express.Router();

router.post("/admin", upload.single("profileImage"), adminValidations, errorIsEmpty, adminController.createAdmin);
